...
namespace GrpcServer {
  public static partial class Customer
  {
    ...
    static readonly grpc::Marshaller<global::GrpcServer.CustomerLookpuModel> __Marshaller_CustomerLookpuModel = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::GrpcServer.CustomerLookpuModel.Parser.ParseFrom);
    ...
    {
      public virtual global::System.Threading.Tasks.Task<global::GrpcServer.CustomerModel> GetCustomerInfo(global::GrpcServer.CustomerLookpuModel request, grpc::ServerCallContext context)
      {
    ...
    {
      serviceBinder.AddMethod(__Method_GetCustomerInfo, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::GrpcServer.CustomerLookpuModel, global::GrpcServer.CustomerModel>(serviceImpl.GetCustomerInfo));
